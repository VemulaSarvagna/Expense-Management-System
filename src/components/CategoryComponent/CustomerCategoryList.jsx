...
//                       <td>
//                         <Link to={`/CategoryExpenseEntry/${category.categoryId}`}>
//                           <button style={{ marginLeft: "10px" }} className="btn btn-info">Expense Entry</button>
//                         </Link>
//                       </td>
//                       </tr>
//                   ) )
                        ...
                        <tbody>
                            {
                                categories.map((category, index) => (
                                    <tr key={category.categoryId}>
                                        ...
                                        <td>{category.description}</td>
                                        <td>
                                            <Link to={`/CategoryExpenseList/${category.categoryId}`}>
                                                <button style={{ marginLeft: "10px" }} className="btn btn-info">Expense Entry</button>
                                            </Link>
                                        </td>
                                    </tr>
