...
//                             <input placeholder="Expense Id" name="expenseId" className="form-control" value={newId} />
//                         </div>
//                         <div className="form-group">
...
//                             </select>
//                             {errors.categoryId && (
//                                 <p style={{ color: "red", fontSize: "14px" }}>{errors.categoryId}</p>)}
//                         </div>

//                         <div className="form-group">
//                             <label>Date: </label>
//                             <input type="date" name="expenseDate" className="form-control"
//                                     value={expense.expenseDate} onChange={onChangeHandler} />
//                             {errors.expenseDate && (
//                                 <p style={{ color: "red", fontSize: "14px" }}>{errors.expenseDate}</p>)}
//                         </div>
//                         <div className="form-group">
//                             <label>Amount: </label>
//                             <input placeholder="Expense Amount" name="amount" className="form-control"
//                                 value={expense.amount} onChange={onChangeHandler} />
//                             {errors.amount && (
//                                 <p style={{ color: "red", fontSize: "14px" }}>{errors.amount}</p>)}
//                         </div>
//                         <div className="form-group">
//                             <label>Description: </label>
//                             <input placeholder="Expense Description" name="description" className="form-control"
//                                 value={expense.description} onChange={onChangeHandler} />
//                             {errors.description && (
